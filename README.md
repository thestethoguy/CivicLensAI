...
|:---:|---|---|
| 📸 **Photo uploaded** | Gemini Vision classifies, severity-rates, and drafts a municipal email in < 3 s | Intake Agent (Gemini 2.5 Flash) |
| 🗺️ **Issue plotted** | Live Google Maps dashboard updates instantly with a severity-coded pin | Google Maps JS API |
| 🤖 **Community verifies** | A second Gemini agent independently scores the issue, writes an impact analysis and action plan | Consensus Agent (Gemini 2.5 Flash) |
...
│   │
│   └── services/
│       └── gemini_service.py   # Gemini 2.5 Flash singleton — shared by both agents
│
...
**Backend:** FastAPI · MongoDB · Pydantic v2 &nbsp;|&nbsp; **AI:** Google Gemini 2.5 Flash &nbsp;|&nbsp; **Maps:** Google Maps JS API &nbsp;|&nbsp; **Cloud:** Google Cloud Run
